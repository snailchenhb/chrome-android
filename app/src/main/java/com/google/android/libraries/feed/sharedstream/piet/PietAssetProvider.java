...
public class PietAssetProvider implements AssetProvider {
  ...
  public PietAssetProvider(
    ...
    this.clock = clock;
    this.fadeImageThresholdMs = config.getValueOrDefault(ConfigKey.FADE_IMAGE_THRESHOLD_MS, 80);
  }
  ...
  @Override
  public boolean shouldPietResizeBitmaps() {
    // No hosts currently keep in-memory bitmaps caches.  Allow Piet to resize them.
    return true;
  }
