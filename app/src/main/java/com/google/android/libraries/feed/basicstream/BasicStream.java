...
public class BasicStream implements Stream, ModelProviderObserver, OnLayoutChangeListener {
  ...
  PietManager createPietManager(
    ...
    return new PietManager(
        debugBehavior,
        new PietAssetProvider(imageLoaderApi, cardConfiguration, clock, configuration),
  ...
  public void onLayoutChange(
    ...
    contextMenuManager.onDimensionsChanged();
  }
  ...
  private void setupRecyclerView() {
    ...
    recyclerView.setItemAnimator(new StreamItemAnimator(streamContentChangedListener));
  ...
  public void onSessionStart() {
    ...
    updateAdapter(localModelProvider);
    if (loggingState == LoggingState.STARTING) {
  ...
  ContextMenuManagerImpl createContextMenuManager(
    ...
    ContextMenuManagerImpl manager = new ContextMenuManagerImpl(menuMeasurer, context);
