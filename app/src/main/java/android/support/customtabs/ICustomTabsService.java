...
mRemote.transact(Stub.TRANSACTION_newSessionWithExtras, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
mRemote.transact(Stub.TRANSACTION_requestPostMessageChannelWithExtras, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
