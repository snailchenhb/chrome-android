...
public final class ParsedFeaturePolicyDeclaration extends org.chromium.mojo.bindings.Struct {
        ...
        try {
            ...
            result = new ParsedFeaturePolicyDeclaration(elementsOrVersion);
                ...
                result.disposition = decoder0.readInt(16);
                    FeaturePolicyDisposition.validate(result.disposition);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (this.origins == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.origins.length, 24, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
