...
class MediaController_Internal {
    ...
    private static final int TOGGLE_SUSPEND_RESUME_ORDINAL = 2;

    private static final int ADD_OBSERVER_ORDINAL = 3;

    private static final int PREVIOUS_TRACK_ORDINAL = 4;

    private static final int NEXT_TRACK_ORDINAL = 5;

    private static final int SEEK_ORDINAL = 6;
