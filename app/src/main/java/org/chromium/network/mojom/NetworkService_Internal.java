...
class NetworkService_Internal {
    ...
    private static final int UPDATE_SIGNED_TREE_HEAD_ORDINAL = 13;

    private static final int UPDATE_CRL_SET_ORDINAL = 14;

    private static final int ON_CERT_DB_CHANGED_ORDINAL = 15;

    private static final int ADD_CORB_EXCEPTION_FOR_PLUGIN_ORDINAL = 16;

    private static final int REMOVE_CORB_EXCEPTION_FOR_PLUGIN_ORDINAL = 17;

    private static final int ON_MEMORY_PRESSURE_ORDINAL = 18;

    private static final int ON_APPLICATION_STATE_CHANGE_ORDINAL = 19;
