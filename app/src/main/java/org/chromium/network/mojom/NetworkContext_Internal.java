...
class NetworkContext_Internal {
    ...
    private static final int WRITE_CACHE_METADATA_ORDINAL = 8;

    private static final int CLEAR_CHANNEL_IDS_ORDINAL = 9;

    private static final int CLEAR_HOST_CACHE_ORDINAL = 10;

    private static final int CLEAR_HTTP_AUTH_CACHE_ORDINAL = 11;

    private static final int CLEAR_REPORTING_CACHE_REPORTS_ORDINAL = 12;

    private static final int CLEAR_REPORTING_CACHE_CLIENTS_ORDINAL = 13;

    private static final int CLEAR_NETWORK_ERROR_LOGGING_ORDINAL = 14;

    private static final int CLEAR_DOMAIN_RELIABILITY_ORDINAL = 15;

    private static final int GET_DOMAIN_RELIABILITY_JSON_ORDINAL = 16;

    private static final int QUEUE_REPORT_ORDINAL = 17;
    ...
    private static final int LOOKUP_BASIC_AUTH_CREDENTIALS_ORDINAL = 48;

    private static final int ENABLE_STATIC_KEY_PINNING_FOR_TESTING_ORDINAL = 49;

    private static final int SET_FAILING_HTTP_TRANSACTION_FOR_TESTING_ORDINAL = 50;

    private static final int VERIFY_CERTIFICATE_FOR_TESTING_ORDINAL = 51;

    private static final int ADD_DOMAIN_RELIABILITY_CONTEXT_FOR_TESTING_ORDINAL = 52;

    private static final int FORCE_DOMAIN_RELIABILITY_UPLOADS_FOR_TESTING_ORDINAL = 53;
